...
package de.knurt.heinzelmann.spring.validation;
...
public class JmValidationUtils extends ValidationUtils {
     ...
     * @param errorArgs the error arguments, for argument binding via MessageFormat (can be null)
     * @param defaultMessage fallback default message
     * @param wrongValues list of values that are rejected
     */
    ...
    /**
     * Call <code>JmValidationUtils.rejectIfEmptyOrOneOfValues(errors, field, errorCode, null, defaultMessage, wrongValues);</code>
     * @see JmValidationUtils#rejectIfNotEmail(org.springframework.validation.Errors, java.lang.String, java.lang.String, java.lang.Object[], java.lang.String)
     * @param errors the Errors instance to register errors on
     * @param field the field name to check
     * @param errorCode error code, interpretable as message key
     * @param defaultMessage fallback default message
    ...
    /**
     * Reject the given field with the given error code (and default message) if the value is not a valie email address
     * @param errors the Errors instance to register errors on
     * @param field the field name to check
     * @param errorCode error code, interpretable as message key
     * @param errorArgs the error arguments, for argument binding via MessageFormat (can be null)
    ...
    /**
     * Call <code>JmValidationUtils.rejectIfNotEmail(errors, field, errorCode, null, null);</code>
     * @see JmValidationUtils#rejectIfNotEmail(org.springframework.validation.Errors, java.lang.String, java.lang.String, java.lang.Object[], java.lang.String)
     * @param errors the Errors instance to register errors on
     * @param field the field name to check
     * @param errorCode error code, interpretable as message key
    ...
    /**
     * Call <code>JmValidationUtils.rejectIfNotEmail(errors, field, errorCode, null, defaultMessage);</code>
     * @see JmValidationUtils#rejectIfNotEmail(org.springframework.validation.Errors, java.lang.String, java.lang.String, java.lang.Object[], java.lang.String)
     * @param errors the Errors instance to register errors on
     * @param field the field name to check
     * @param errorCode error code, interpretable as message key
    ...
    /**
     * Reject a password field, if input is not safe enough
     * This does not check, if a password is valid (because of invalid characters, pass1 != pass2 etc.)
     * @param errors the Errors instance to register errors on
     * @param field the field name to check
     * @param errorCode error code, interpretable as message key
     * @param errorArgs the error arguments, for argument binding via MessageFormat (can be null)
     * @param defaultMessage fallback default message
     * @param minLength minimal length of the password to be safe
     * @param minDigits minimal count of digits of the password to be safe
     * @param minUpper minimal count of upper cased chars of the password to be safe
     * @param minLower minimal count of lower cased chars of the password to be safe
     * @param minSpecial minimal count of special chars of the password to be safe
     */
